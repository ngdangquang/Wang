...
module.exports = (client) => {
  try {
    client.distube
                ...
                i.reply({
                  embeds: [
                    new MessageEmbed()
                      .setColor(ee.color)
                      .setTimestamp()
                      .setTitle(`⏹ **Dừng chơi và thoát khỏi channel**`)
                      .setFooter(
              ...
              i.reply({
                embeds: [
                  new MessageEmbed()
                    .setColor(ee.color)
                    .setTimestamp()
                    .setTitle(`⏭ **Skip đến bài tiếp theo!**`)
                    .setFooter(
                      `💢 Action by: ${member.user.tag}`,
                      member.user.displayAvatarURL({ dynamic: true })
                    ),
            ...
            if (i.customId == `3`) {
              ...
              if (newQueue.playing) {
                ...
                var data = receiveQueueData(
                  client.distube.getQueue(queue.id),
                  newQueue.songs[0]
                );
              ...
              i.reply({
                embeds: [
                  new MessageEmbed()
                    .setColor(ee.color)
                    .setTimestamp()
                    .setTitle(`🔀 **Xáo trộn ${newQueue.songs.length}!**`)
                    .setFooter(
                      `💢 Action by: ${member.user.tag}`,
                      member.user.displayAvatarURL({ dynamic: true })
                    ),
                    ...
                    .setTitle(
                      `${
                        newQueue.repeatMode == 1
                          ? `${client.allEmojis.check_mark} **Kích hoạt Song-Loop**`
                          : `${client.allEmojis.x} **Vô hiệu hoá Song-Loop**`
                      }`
                    )
                    .setFooter(
                      `💢 Action by: ${member.user.tag}`,
              ...
              i.reply({
                embeds: [
                  new MessageEmbed()
                    .setColor(ee.color)
                    .setTimestamp()
                    .setTitle(`⏩ **Tua nhanh bài nhạc đi \`10 giây\`!**`)
                    .setFooter(
                      `💢 Action by: ${member.user.tag}`,
                      member.user.displayAvatarURL({ dynamic: true })
                    ),
        ...
        queue.textChannel.send({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(
                `👍 Bài hát: [\`${song.name}\`](${song.url})  -  \`${song.formattedDuration}\``
              )
              .addField(
                `⌛ **Estimated Time:**`,
      ...
      .on(`empty`, (channel) =>
        channel
          .send(`Voice channel is empty! Leaving the channel...`)
        ...
        queue.textChannel.send({
          embeds: [
            new MessageEmbed()
              .setColor(ee.color)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle("⛔️ THOÁT KHỎI CHANNEL")
              .setDescription(":headphones: **không còn bài nhạc nào**")
              .setTimestamp(),
          ],
        });
      })
  ...
  function receiveQueueData(newQueue, newTrack) {
    ...
    if (djs.length == 0) djs = "`chưa thiết lặp`";
    ...
    var embed = new MessageEmbed()
      ...
      .addField(
        `❔ Tải nhạc:`,
        `>>> [\`Click vào đây\`](${newTrack.streamURL})`,
        true
      )
      .addField(
    ...
    let songloop = new MessageButton()
      .setStyle("SUCCESS")
      .setCustomId("6")
      .setEmoji(`🔁`)
      .setLabel(`Song`);
    let queueloop = new MessageButton()
      .setStyle("SUCCESS")
      .setCustomId("7")
      .setEmoji(`🔂`)
      .setLabel(`Queue`);
