...
module.exports = {
	...
	usage: "nowplaying",
	aliases: ["np", "current"],
	description: "Show nhạc đang chơi", //the command description for Slash Command Overview
	cooldown: 5,
			...
			try {
				...
				message.reply({
					...
					embeds: [
						...
						.addField(`🌀 Danh sách chờ:`, `>>> \`${newQueue.songs.length} song(s)\`\n\`${newQueue.formattedDuration}\``, true)
						...
						.addField(`↪️ Tự động chơi:`, `>>> ${newQueue.autoplay ? `${client.allEmojis.check_mark}` : `${client.allEmojis.x}`}`, true)
						.addField(`❔ Tải nhạc:`, `>>> [\`Click vào đây\`](${newTrack.streamURL})`, true)
