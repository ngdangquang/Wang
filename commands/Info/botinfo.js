      ...
      cpuStat.usagePercent(function (e, percent, seconds) {
        try {
          ...
          const botinfo = new MessageEmbed()
            ...
            .addField(
              "📁 Users",
              `\`Tổng: ${client.users.cache.size} Users\``,
              true
            )
            .addField(
              "📁 Servers",
              `\`Tổng: ${client.guilds.cache.size} Servers\``,
              true
            )
            .addField("\u200b", `\u200b`, true)
            .addField(
            ...
            .addField("🤖 CPU đã sử dụng", `\`${percent.toFixed(2)}%\``, true)
            ...
            .setFooter(
              "Coded by: Wang#3133",
              "https://images-ext-2.discordapp.net/external/ZzJtqYpc71hLJ0859i5jimW8v5X2kwh_14n_crrfWts/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/353008425749184525/848f377fef3501ee3fc7e9caabf2d9b0.webp?width=559&height=559"
            );
          message.reply({
            embeds: [botinfo],
          });
