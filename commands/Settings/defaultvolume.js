...
module.exports = {
  ...
  description: "Chỉnh volume mặc định cho bot!", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      if (!args[0]) {
        return message.reply({
          embeds: [
            ...
            .setTitle(`${client.allEmojis.x} **Vui lòng ghi số volume!**`)
      ...
      return message.reply({
        embeds: [
          ...
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setTitle(`${client.allEmojis.check_mark} **Volume mặc định đã được set: \`${volume}\`!**`)
        ],
      })
    } catch (e) {
