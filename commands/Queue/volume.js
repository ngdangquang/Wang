...
module.exports = {
	...
	description: "Điều chỉnh âm lượng cho nhạc", //the command description for Slash Command Overview
	cooldown: 10,
		...
		try {
			...
			try {
				...
				if (!newQueue || !newQueue.songs || newQueue.songs.length == 0) return message.reply({
					embeds: [
						new MessageEmbed().setColor(ee.wrongcolor).setTitle(`${client.allEmojis.x} **Tôi đang không chơi nhạc**`)
					],
				...
				if (volume > 150 || volume < 0) return message.reply({
					embeds: [
						new MessageEmbed().setColor(ee.wrongcolor).setTitle(`${client.allEmojis.x} **Âm lượng phải trong khoảng \`0\` và \`150\`!**`)
					],
